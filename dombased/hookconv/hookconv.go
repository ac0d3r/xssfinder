...
// TODO 待完善
func HookConv(jscode string) (string, error) {
	ast, err := js.Parse(parse.NewInputString(jscode), js.Options{})
	if err != nil {
		return "", err
	}
	convWalk(ast)
...
func convExpr(node js.IExpr) js.IExpr {
	...
	case *js.BinaryExpr:
		...
		case js.AddToken: // +
			return &js.CallExpr{
				X: &js.Var{Data: []byte("__dombasedxssfinder_plus")},
				Args: js.Args{
		...
		case js.EqEqToken: // ==
			return &js.CallExpr{
				X: &js.Var{Data: []byte("__dombasedxssfinder_equal")},
				Args: js.Args{
					List: []js.Arg{{Value: convExpr(n.X)}, {Value: convExpr(n.Y)}},
				},
			}
		case js.NotEqToken: // !=
			return &js.CallExpr{
				X: &js.Var{Data: []byte("__dombasedxssfinder_notEqual")},
				Args: js.Args{
					List: []js.Arg{{Value: convExpr(n.X)}, {Value: convExpr(n.Y)}},
				},
			}
		case js.EqEqEqToken: // ===
			return &js.CallExpr{
				X: &js.Var{Data: []byte("__dombasedxssfinder_strictEqual")},
				Args: js.Args{
					List: []js.Arg{{Value: convExpr(n.X)}, {Value: convExpr(n.Y)}},
				},
			}
		case js.NotEqEqToken: // !==
			return &js.CallExpr{
				X: &js.Var{Data: []byte("__dombasedxssfinder_strictNotEqual")},
				Args: js.Args{
					List: []js.Arg{{Value: convExpr(n.X)}, {Value: convExpr(n.Y)}},
				},
			}
		case js.EqToken: // =
			if _, ok := n.X.(*js.DotExpr); ok {
				return &js.CallExpr{
					X: &js.Var{Data: []byte("__dombasedxssfinder_put")},
					Args: js.Args{
	...
	case *js.DotExpr:
		return &js.CallExpr{
			X: &js.Var{Data: []byte("__dombasedxssfinder_get")},
			Args: js.Args{
	...
	case *js.CallExpr:
		...
		if dot, ok := n.X.(*js.DotExpr); ok {
			...
			return &js.CallExpr{
				X:    &js.Var{Data: []byte("__dombasedxssfinder_property_call")},
				Args: args,
			}
		} else {
			args := js.Args{
			...
			return &js.CallExpr{
				X:    &js.Var{Data: []byte("__dombasedxssfinder_call")},
				Args: args,
			}
		}
	case *js.UnaryExpr:
		...
		case js.TypeofToken:
			...
			default:
				return &js.CallExpr{
					X: &js.Var{Data: []byte("__dombasedxssfinder_typeof")},
					Args: js.Args{
	...
	case *js.NewExpr:
		if v, ok := n.X.(*js.Var); ok && string(v.Data) == "Function" {
			return &js.CallExpr{
				X:    &js.Var{Data: []byte("__dombasedxssfinder_new_Function")},
				Args: *n.Args,
			}
		}
	}
